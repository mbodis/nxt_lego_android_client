...
public class BTCommunicator extends Thread {
    ...
    private void doAction(int actionNr, int value2) {
        byte[] message = LCPMessage.getActionMessage(actionNr, value2);
        sendMessageAndState(message);
    }
    
    //SVB
    private void setGameType(int gameType){
    	byte[] message = LCPMessage.getGameType(gameType);
    	sendMessageAndState(message);
    }
    
    //SVB
    private void setRobotType(int gameType){
    	byte[] message = LCPMessage.getRobotType(gameType);
    	sendMessageAndState(message);
    }
        ...
        public void handleMessage(Message myMessage) {
            ...
            switch (message = myMessage.getData().getInt("message")) {
                ...
                case DO_BEEP:
                    ...
                    break;
                case DO_ACTION:                	
                    doAction(myMessage.getData().getInt("value1"), myMessage.getData().getInt("value2"));
                    break;                    
                case GAME_TYPE://SVB                	
                	setGameType(myMessage.getData().getInt("value1"));
                    break;
                case ROBOT_TYPE://SVB
                	setRobotType(myMessage.getData().getInt("value1"));
                    break;
